...
const (
	MarketDataService_GetAssets_FullMethodName = "/MarketDataService/GetAssets"
)
...
func (c *marketDataServiceClient) GetAssets(ctx context.Context, in *AssetRequest, opts ...grpc.CallOption) (*AssetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AssetResponse)
	err := c.cc.Invoke(ctx, MarketDataService_GetAssets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMarketDataServiceServer) GetAssets(context.Context, *AssetRequest) (*AssetResponse, error) {
...
func _MarketDataService_GetAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MarketDataServiceServer).GetAssets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MarketDataService_GetAssets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MarketDataServiceServer).GetAssets(ctx, req.(*AssetRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _MarketDataService_GetAssets_Handler,
		},
	},
